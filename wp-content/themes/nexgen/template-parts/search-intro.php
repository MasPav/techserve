...
$search_intro_heading     = get_field( 'nxg_search_intro_h6', 'option' );
$search_intro_description = get_field( 'nxg_search_intro_p', 'option' );
...
if ( have_posts() ) {
	...
	if ( $search_intro_heading ) {
		$search_heading     = nxg_translate( $search_intro_heading['text_results'] ) ?? '';
		$search_description = nxg_translate( $search_intro_description['text_results'] ) ?? '';
	...
	if ( $search_intro_heading ) {
		$search_heading     = nxg_translate( $search_intro_heading['text_no_results'] ) ?? '';
		$search_description = nxg_translate( $search_intro_description['text_no_results'] ) ?? '';
