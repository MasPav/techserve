...
class NXG_Counter extends Widget_Base {
        ...
        <div class="item">
          ...
          if ( $settings['number_position'] === 'top' ) { ?>
            ...
            <?php if ( $settings['number'] ) { ?>
              <div data-percent="<?php echo $settings['number']; ?>" data-color="#606D75" data-empty-color="#cccccc" class="radial">
      ...
      view.addInlineEditingAttributes( 'paragraph', 'basic' );
		...
		<div class="counter funfacts">
          ...
          <# if ( settings.number_position === 'top' ) { #>
            ...
            <div data-percent="{{{ settings.number }}}" data-color="#606D75" data-empty-color="#cccccc" class="radial">
